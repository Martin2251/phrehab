  ...
  return (
    <div style={{ maxWidth: '850px', margin: '0 auto', padding: '40px 20px', fontFamily: 'Arial, sans-serif', color: '#222' }}>
      ...
      <section>
        ...
        <p>The Data controller is Mr Prince John Adesuyi Enitan Haastrup (Physiotherapist)  trading as PH Sports Rehab:  </p>
        <p><strong>Privacy Policy  </strong></p>
        <p>GDPR is bringing in new legal protection for personal information from the 25th  May 2018. This Privacy Policy sets out how PH Sports Rehab uses and protects  the information that you give to us when you register as a patient. PH Sports  Rehab is committed to protecting and respecting your privacy and complying  with the principles of the GDPR. We fully respect the confidentiality of the  information that you may share with us.  </p>
        <p><strong>The purpose of processing your information</strong></p>
        <p>We aim to process information about you in a secure and transparent way that  enables us to carry out our job of assessing and managing you, whilst holding  your data in a way that you can understand and complies to current legislation.  
When you register as a client at PH Sport Rehab we will ask you for some basic  personal data including name, address, date of birth, contact details and medical  information both relevant to the condition you have been referred for/have  referred yourself for and any other medical information about your general  health. This will help us to assess your condition and manage you in the most  appropriate way that suits your individual needs. We may also use your  information to promote our services and to support and manage our staff.
</p>
<p><strong>The Lawful basis for processing your information</strong></p>
<p>At pH Sports Rehab and as members of The Health and Care Professions Council  (HCPC) and the Chartered Society of Physiotherapy (CSP) we abide by the HCPC  and CSP’s practice and ethics. The Lawful basis under which we hold and use  your information is our legitimate interests; our requirement to retain the  information to provide you with the best possible assessment and management  of your condition.  
...
<p>The information we hold includes your: </p>
 <ul style={{ 
  ...
  marginBottom: '10px' 
    ...
    <li>From time to time we may send you an email with news about our clinics: the  range of services we offer, clinic promotions and news and articles of interest to  you.  </li>
    <li>To improve our services offered to you.  </li>
    
  </ul>
  <p>The information you provide us with is held in strict confidence. We will NOT sell,  distribute or disclose your information to third parties unless we have your  permission or are required to do so by law or by following best medical practice.  </p>
      </section>
      <section>
        <p><strong>How we store your information </strong></p>
        <p>Your information is stored securely using a combination of password‑protected,  encrypted computers, secure cloud‑based practice management software  (WriteUp), and internal paper records/patient files. WriteUp is used to manage  patient records, appointment scheduling, and clinical notes, and complies with  UK GDPR requirements. This information allows us to provide you with health  services, to manage your records and appointments, and to correspond (if  applicable and consent given) with your referring consultant, insurer, or case  management company to process your claim, where appropriate.  </p>
        <p><strong>Retention period for your information  </strong></p>
        <p>Your patient file information is held for a minimum of 8 years (as required by  The Data Protection Act). All financial records are retained for a minimum of 7  years.  </p>
        <p><strong>Security  </strong></p>
        <p>The protection of your personal information is extremely important to us, we are  committed to ensuring that your information is secure, and we strive to protect  your personal information using means reasonably required by us to do so. We  have physical, electronic and managerial procedures to secure the information  that you supply us with. As no form of data storage and transmission is 100%  reliable, we cannot guarantee its absolute security. Therefore, we make no 
warranties as to the level of security afforded to your data. We will, however,  always aim to act in accordance with the relevant legislation. We will not share  your information with anyone other than the professionals (NHS/private  referrers) and intermediaries, (insurer, solicitor, employer or other party) that  you have given us permission to share your information with. Your data will not  be transferred outside the EU without your consent.  
</p>
...
<ul style={{ 
  ...
  <li>The right to erasure (also called “the right to be forgotten”): For you to  request your therapist to erase any information they hold about you  </li>
  <li>The right to restrict processing of personal data: You have the right to request  limits on how your therapist uses your personal information </li>
